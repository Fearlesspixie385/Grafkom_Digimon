...
public class Circle1 extends Object {
    Float radiusX;
    Float radiusY;
    public Circle1(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, List<Float> centerPoint, Float radiusX,Float radiusY) {
